...
# --------------------------------
with st.sidebar.header('File 1. Upload your "Malaria Deaths by Country for all ages" csv data'):
    uploaded_file1 = st.sidebar.file_uploader("Upload your input TXT file", type=["txt"],key='upload_df_m_deaths')
with st.sidebar.header('File 2. Upload your "Malaria Incidence by Country for all ages" csv data'):
    uploaded_file2 = st.sidebar.file_uploader("Upload your input TXT file", type=["txt"],key='upload_df_m_inc')
with st.sidebar.header('File 3. Upload your "Malaria deaths by age group" csv data'):
    uploaded_file3 = st.sidebar.file_uploader("Upload your input TXT file", type=["txt"],key='upload_df_m_age')
# --------------------------------

# --------------------------------
# 1) Web App Title
# --------------------------------
st.title("Technical Assessment - Joel Wong")
st.header('*_Data Visualisation on Malaria in the World_*')
...
if uploaded_file1 is not None:
    ...
    if btn_base_plot1:
        ...
        1. General Trend
            ...
            * All regions except "Sub-saharan Africa" and "Melanesia", have had relatively high Malaria deaths throughout the time period of years 1990 to 2016.
            * The death toll for the rest of the world is nearly close to 0 in comparison with the "Sub-Saharan Africa" and "Melanesia".
        1. Melaria deaths in "Melanesia" rose significantly around year 1998, before falling after year 2004. The level of Malaria deaths eventually fall to levels comapriable to the other regions of the world.
        1. "Sub-saharan Africa" is a concern, given that it has consistently the highest Malaria Deaths compared to all the other regions in the world.
            * We should proceed study further on the "Sub-saharan Africa" region to understand more.
...
if uploaded_file3 is not None:
    ...
    if btn_base_plot3:
        ...
        1. The death toll for the rest of the Age Groups are nearly close to 0 when compared to the Age Group of "Under 5".
