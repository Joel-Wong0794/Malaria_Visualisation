...
st.markdown('''
_Some of the highest average Malaria Deaths are found in countries in the continent of Africa, as seen by the more intense coloured and larger size circles in the map._
''')
# --------------------------------
...
if uploaded_file1 is not None: # If user did upload the required file
    ...
    if btn_base_plot1:
        ...
        1. General Trend
            ...
            * The death toll for the rest of the world is nearly close to zero in comparison with the "Sub-Saharan Africa" and "Melanesia".
        1. Melaria deaths in "Melanesia" rose significantly around year 1998, before falling after year 2004. The level of Malaria deaths eventually fall to levels comapriable to the other regions of the world (except "Sub-Saharan Africa").
